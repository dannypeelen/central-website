...
import { AmplifyFunction, ConstructFactory, LogLevel, LogRetention } from '@aws-amplify/plugin-types';
/**
...
export type AmplifyDataError = 'DefineDataConfigurationError' | 'InvalidSchemaAuthError' | 'InvalidSchemaError' | 'MultipleSingletonResourcesError' | 'UnresolvedEntryPathError';
/**
